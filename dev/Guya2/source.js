...
r($,"k8","hu",()=>{A.j9()
return A.i8("getBoolean","https://github.com/getBoolean",B.u,"Extension that pulls manga from Guya.moe.","icon.png","gb","Guya (Dart)",A.Q([new A.am({text:"Notifications",type:"success"})],A.cC("v<am>")),"2.0.0b1","https://guya.cubari.moe")})})();(function nativeSupport(){!function(){var s=function(a){var m={}
m[a]=1
