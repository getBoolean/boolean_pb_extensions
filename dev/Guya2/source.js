...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    allowInteropCaptureThis(f) {
      if (typeof f == "function")
        ...
        return type$.Function._as(A._convertDartFunctionFastCaptureThis(f));
    },
    ...
    main() {
      A.register(A.guya_Guya___new_tearOff$closure(), "Guya2", $.$get$guyaInfo(), type$.Guya);
    },
    Guya___new_tearOff() {
    ...
    defineGetter(object, $name, value) {
      var t1 = {value: value, enumerable: false};
      self.Object.defineProperty(object, $name, t1);
    },
    allowInteropCaptureThisNamed($name, $function) {
      $function = A.allowInteropCaptureThis($function);
      A.defineGetter($function, "name", $name);
      A._hideDartProperties($function);
      return $function;
    },
    _hideDartProperties(object) {
      var t1, t2, t3, t4;
      for (t1 = J.cast$1$0$ax(self.Object.getOwnPropertyNames(object), type$.String), t2 = A._instanceType(t1), t1 = new A.ListIterator(t1, t1.get$length(t1), t2._eval$1("ListIterator<ListMixin.E>")), t2 = t2._eval$1("ListMixin.E"); t1.moveNext$0();) {
  ...
  A.register_closure.prototype = {
    call$0() {
      var _s17_ = "getChapterDetails",
        _s16_ = "getSearchResults",
        _s18_ = "filterUpdatedManga",
        _s26_ = "getCloudflareBypassRequest",
        _s19_ = "getHomePageSections",
        _s16_0 = "getMangaShareUrl",
        _s16_1 = "getViewMoreItems",
        _s24_ = "getWebsiteMangaDirectory",
        _s23_ = "supportsSearchOperators",
        _s20_ = "supportsTagExclusion",
        source = new A.SourceFutureToPromiseAdatper(this.creator.call$0());
      return A.JsObject_JsObject$jsify(A.LinkedHashMap_LinkedHashMap$_literal([_s17_, A.allowInteropCaptureThisNamed(_s17_, source.get$getChapterDetails(source)), "getChapters", A.allowInteropCaptureThisNamed("getChapters", source.get$getChapters(source)), "getMangaDetails", A.allowInteropCaptureThisNamed("getMangaDetails", source.get$getMangaDetails(source)), _s16_, A.allowInteropCaptureThisNamed(_s16_, source.get$getSearchResults(source)), _s18_, A.allowInteropCaptureThisNamed(_s18_, source.get$filterUpdatedManga(source)), _s26_, A.allowInteropCaptureThisNamed(_s26_, source.get$getCloudflareBypassRequest(source)), _s19_, A.allowInteropCaptureThisNamed(_s19_, source.get$getHomePageSections(source)), _s16_0, A.allowInteropCaptureThisNamed(_s16_0, source.get$getMangaShareUrl(source)), "getSearchFields", A.allowInteropCaptureThisNamed("getSearchFields", source.get$getSearchFields(source)), "getSearchTags", A.allowInteropCaptureThisNamed("getSearchTags", source.get$getSearchTags(source)), "getSourceMenu", A.allowInteropCaptureThisNamed("getSourceMenu", source.get$getSourceMenu(source)), _s16_1, A.allowInteropCaptureThisNamed(_s16_1, source.get$getViewMoreItems(source)), _s24_, A.allowInteropCaptureThisNamed(_s24_, source.get$getWebsiteMangaDirectory(source)), _s23_, A.allowInteropCaptureThisNamed(_s23_, source.get$supportsSearchOperators(source)), _s20_, A.allowInteropCaptureThisNamed(_s20_, source.get$supportsTagExclusion(source))], type$.String, type$.Function));
    },
    $signature: 36
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    var _;
    _instance(_ = A.SourceFutureToPromiseAdatper.prototype, "get$filterUpdatedManga", 1, 3, null, ["call$3"], ["filterUpdatedManga$3"], 21, 0, 0);
    _instance_2_i(_, "get$getChapterDetails", "getChapterDetails$2", 22);
    _instance_1_i(_, "get$getChapters", "getChapters$1", 23);
    _instance_0_i(_, "get$getCloudflareBypassRequest", "getCloudflareBypassRequest$0", 24);
    _instance_1_i(_, "get$getHomePageSections", "getHomePageSections$1", 39);
    _instance_1_i(_, "get$getMangaDetails", "getMangaDetails$1", 26);
    _instance_1_i(_, "get$getMangaShareUrl", "getMangaShareUrl$1", 27);
    _instance_0_i(_, "get$getSearchFields", "getSearchFields$0", 28);
    _instance_2_i(_, "get$getSearchResults", "getSearchResults$2", 29);
    _instance_0_i(_, "get$getSearchTags", "getSearchTags$0", 30);
    _instance_0_i(_, "get$getSourceMenu", "getSourceMenu$0", 31);
    _instance_2_i(_, "get$getViewMoreItems", "getViewMoreItems$2", 32);
    _instance_1_i(_, "get$getWebsiteMangaDirectory", "getWebsiteMangaDirectory$1", 33);
    _instance_0_i(_, "get$supportsSearchOperators", "supportsSearchOperators$0", 6);
    _instance_0_i(_, "get$supportsTagExclusion", "supportsTagExclusion$0", 6);
  })();
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "guyaInfo", "$get$guyaInfo", () => {
      A.createSentinel();
      return A.SourceInfo$("getBoolean", "https://github.com/getBoolean", B.ContentRating_everyone, "Extension that pulls manga from Guya.moe.", "icon.png", "gb", "Guya (Dart)", A._setArrayType([new A.SourceTag({text: "Notifications", type: "success"})], A.findType("JSArray<SourceTag>")), "2.0.0-alpha.3", "https://guya.cubari.moe");
    });
  })();
